export const soloLarge = [
  {
    ...
    howToImprove: [
      "Backend introduction of Express/Django for Stripe payments",
      "Cart Feature to hold client products",
    ],
...

  {
    ...
    newSkills: [
      ...
      "Power and flexibility of grid/flexbox combination",
    ],
    howToImprove: [
      "Learn how to use Figma editor/SVGs for controlled styling",
      "Audio or video background window effects",
    ],
...

  {
    ...
    howToImprove: [
      "Fetch data from API",
      "Add grid/flexbox layout for consistency/efficiency",
    ],
